...
export default function Hero() {
  return (
    <>
      <section className="section h-screen border">
        <div className="container space-y-8 pt-8">
          {/* image */}
          <div className="mx-auto size-36 overflow-hidden rounded-full border-4 border-blue-500 sm:size-40">
          ...
          <div className="text-center">
            ...
            <div className="flex flex-col items-center justify-center gap-2 sm:flex-row">
              <a
                href="#project"
                className="btn group border border-blue-600 bg-blue-600 text-white transition-all duration-300 hover:bg-blue-700 hover:scale-105"
              >
                <svg
              ...
              <a href="#" className="btn border border-gray-200 text-gray-500 hover:bg-gray-200">
                <svg
                  xmlns="http://www.w3.org/2000/svg"
                  height="24px"
                  viewBox="0 -960 960 960"
                  width="24px"
                  fill="#e3e3e3"
                  className="inline-block fill-gray-500"
                >
        ...
        <svg
          ...
          width="24px"
          fill="#e3e3e3"
          className="absolute bottom-8 left-1/2 -translate-x-1/2 fill-gray-600 animate-bounce"
        >
